  ...
  return (
    <style>{`
      ...
      @media (max-width: 760px) {
        .yp-focus-layout { grid-template-columns: 1fr !important; }
        .yp-focus-side {
          border-right: 0 !important;
          border-bottom: 2px solid #15211d;
...
export function FocusYarnPullInterface({ game: interfaceGame }) {
  const {
    changeDifficulty,
    difficulty,
    forest,
  ...
  return (
    ...
    >
      <div style={{ maxWidth: 1160, margin: "0 auto", paddingTop: 34 }}>
        <header
          style={{
            display: "grid",
        ...
        >
          ...
          <div style={{ display: "flex", gap: 8, flexWrap: "wrap", justifyContent: "flex-end" }}>
            <div aria-label="Difficulty" style={{ display: "flex", border: "1.5px solid #15211d" }}>
              {DIFFICULTIES.map((option) => (
                <button
                  key={option.id}
                  className={`ypseg${difficulty === option.id ? " active" : ""}`}
                  onClick={() => changeDifficulty(option.id)}
                  style={{
                    color: difficulty === option.id ? "#f4f1e8" : "#15211d",
                    background: difficulty === option.id ? "#15211d" : "transparent",
                    borderColor: "#15211d",
                  }}
                >
                  {option.label}
        ...
        >
          <aside
            className="yp-focus-side"
            style={{
              borderRight: "2px solid #15211d",
              paddingRight: 14,
              display: "flex",
              flexDirection: "column",
              gap: 14,
          ...
          >
            ...
            <div
              style={{
                ...
                border: "1.5px solid #15211d",
              }}
            >
              {[
                ["Cleared", `${game.cleared.size}/${forest.nodes.length}`],
                ["Undo", history.length],
                ["Seed", seed],
                ...
                <div
                  ...
                  style={{
                    padding: "12px 10px",
                    borderRight: index % 2 === 0 ? "1.5px solid #15211d" : "none",
                    borderBottom: index < 2 ? "1.5px solid #15211d" : "none",
                  }}
                >
                  <DebugLabel small>{label}</DebugLabel>
                  <div style={{ fontFamily: FONT_DISPLAY, fontSize: 26, lineHeight: 1 }}>
                    {value}
                  </div>
                </div>
              ))}
          ...
          <main
            style={{
              minWidth: 0,
              border: "2px solid #15211d",
              background: "#fffaf0",
              padding: "12px 12px 6px",
            }}
          >
            <ForestViewport focusKey={`focus-${difficulty}-${seed}-${recenterKey}`}>
              <ForestSVG
                forest={forest}
                visibleIds={game.visible}
                clearedIds={game.cleared}
...
export function FocusYarnPullApp() {
  return <FocusYarnPullInterface game={useYarnPullGame()} />;
}
...
export const YARN_PULL_INTERFACES = [
  ...
  },
  {
    id: "focus",
    label: "Focus",
    Component: FocusYarnPullInterface,
  },
  {
    id: "snake",
    label: "Snake",
